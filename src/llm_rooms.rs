...
fn set_vantage(&mut self, loc: IVec3, order: f32, interest: f32)
*/
...
pub fn rooms() -> Vec<Sparse3D<Cell>> {
    ...
    sunken_courtyard.set_vantage(v(0, 0, 0), /*order=*/ 0.5, /*interest=*/ 0.65);

    // Design 2: Grand Library Hall
    // A tall central hall flanked by multi-level balconies or walkways, suggesting bookshelves.
    // Aims for high order and high interest due to verticality and complexity.
    ...
    library_hall.set_vantage(v(0, 0, 0), /*order=*/ 0.9, /*interest=*/ 0.85);
    ...
    pyramid_core_room.set_vantage(v(0, 0, 6), /*order=*/ 0.8, /*interest=*/ 0.7);
    ...
    chasm_crossing.set_vantage(v(-8, 0, 0), /*order=*/ 0.4, /*interest=*/ 0.8);
    ...
    spiral_room.set_vantage(v(0, 2, 0), /*order=*/ 0.8, /*interest=*/ 0.8);
    ...
    checkerboard_room.set_vantage(v(0, 1, 0), /*order=*/ 0.9, /*interest=*/ 0.7);
    ...
    terrace_room.set_vantage(v(0, 2, 0), /*order=*/ 0.8, /*interest=*/ 0.9);
    ...
    concentric_room.set_vantage(v(0, 1, 0), /*order=*/ 1.0, /*interest=*/ 0.7);
    ...
    labyrinth_room.set_vantage(v(0, 1, 0), /*order=*/ 0.6, /*interest=*/ 0.9);
    ...
    stacked_balconies.set_vantage(v(0, 0, -2), /*order=*/ 0.75, /*interest=*/ 0.85);
    ...
    spiral_terraces.set_vantage(v(0, 3, -4), /*order=*/ 0.8, /*interest=*/ 0.9);
    ...
    cross_walkway.set_vantage(v(0, 0, 0), /*order=*/ 0.95, /*interest=*/ 0.8);
    ...
    chasm_bridge.set_vantage(v(0, 0, -5), /*order=*/ 0.65, /*interest=*/ 0.85);
